...
R_Cyan = L2_Loop2*exp(1i*(q2_Cyan_1+offset)); % at O2
R_Red = L3_Loop2*exp(1i*(q3_Red_1+offset));
R_Cyan_Up = L2_Loop3*exp(1i*(q_in_3_1+offset)); % at O2
...
V_Red_Rel_2 = 1i * R_Red_2 * w_Red_2;
V_Blue_Rel_2 = 1i * R_Blue_2 * w_Blue_2;
...
quiver(real(R_Cyan_2), imag(R_Cyan_2), real(V_Red_Rel_2)/40, imag(V_Red_Rel_2)/40, 0, 'r', 'LineWidth', 1.5, 'MaxHeadSize', 0.5);
quiver(real(R_Cyan_Up_2), imag(R_Cyan_Up_2), real(V_Blue_Rel_2)/40, imag(V_Blue_Rel_2)/40, 0, 'b', 'LineWidth', 1.5, 'MaxHeadSize', 0.5);
